...
class IMS:
    def __init__(self,root):
        ...
        #=======footer============
        lbl_footer=Label(self.root,text="IMS-Inventory Management System| Developed by Shailja\n For any Technical Issue Contact: 7980217039",font=("times new roman",15,),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
#=========================================================================================================
