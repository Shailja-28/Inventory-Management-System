...
class salesClass:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text="View Sales Details",font=("goudy old style",30,"bold"),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20) 
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="#607d8b",fg="white",cursor="hand2").place(x=460,y=100,width=100,height=28)
        ...
        self.img1=self.img1.resize((450,300),Image.LANCZOS)
        self.img1=ImageTk.PhotoImage(self.img1)

        lbl_img=Label(self.root,image=self.img1,bd=0)
        lbl_img.place(x=750,y=140)
