...
class supplierclass:
    def __init__(self,root):
        ...
        #===title====
        title=Label(self.root,text="Supplier Details",font=("goudy old styles",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)        

        #====content======
        #===row1====
        lbl_supplier_invoice=Label(self.root,text="Invoice No.",font=("goudy old styles",15),bg="white").place(x=50,y=80)
        txt_supplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("goudy old styles",15),bg="lightyellow").place(x=180,y=80,width=180)
       
        #===row2====
        lbl_name=Label(self.root,text="Name",font=("goudy old styles",15),bg="white").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old styles",15),bg="lightyellow").place(x=180,y=120,width=180)
        
        #===row3====
        lbl_contact=Label(self.root,text="Contact",font=("goudy old styles",15),bg="white").place(x=50,y=160)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old styles",15),bg="lightyellow").place(x=180,y=160,width=180)
        
         #===row4====
        lbl_desc=Label(self.root,text="Description",font=("goudy old styles",15),bg="white").place(x=50,y=200)
        self.txt_desc=Text(self.root,font=("goudy old styles",15),bg="lightyellow")
